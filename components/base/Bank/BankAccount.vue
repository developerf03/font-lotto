...
<template>
  <div
    class="bank-account-wrapper w-full card-secondary flex justify-between items-center p-2 rounded-md gap-2 <sm:(flex-col gap-4)"
  >
    <div class="flex items-center gap-2 <sm:(w-full)">
      <div class="flex justify-center items-center flex-col gap-2">
        ...
        <img
          ...
          "
          class="w-6 h-6 rounded-full custom-position"
        >
